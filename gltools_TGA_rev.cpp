...
This file "SuperBibleV4GLTools.cpp" has code from gltools.h
and gltools.cpp source files from SuperBible V4.  Below is the comment
header from the original source.
...
I have reduced the content of definitions needed to support only
the bitmap.cpp example.

Please see the original for more functionality.
